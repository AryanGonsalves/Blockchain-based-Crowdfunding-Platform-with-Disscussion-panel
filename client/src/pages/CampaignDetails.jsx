    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          ...
          <div className="relative w-full h-[120px] bg-slate-600 mt-2">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-col-3 rounded-[10px]">
            ...
            {remainingDays >= 0 && compareAmounts() ? (
              <input 
                ...
                placeholder="ETH 0.1"
                step="0.01"
                className="w-full py-[10px] sm:px-[20px] px-[15px] outline-none border-[1px] border-[#3a3a43] bg-transparent font-epilogue text-slate-300 text-[18px] leading-[30px] placeholder:text-slate-400 rounded-[10px]"
                value={amount}
              ...
              <div className="my-[20px] p-4 bg-col-1 rounded-[10px]">
                ...
                <CustomButton 
                btnType="button"
                title={remainingDays >= 1 && compareAmounts() ? "Fund Campaign" : 
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              ...
              <div>
                ...
                <p className="mt-[4px] font-epilogue font-normal text-[12px] text-slate-600">{state.id}</p> 
              </div>
            </div>
          </div>
